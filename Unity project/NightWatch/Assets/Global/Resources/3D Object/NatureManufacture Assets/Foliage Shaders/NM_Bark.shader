            ...
            //-------------------------------------------------------------------------------------
                ...
                // Pixel Graph Evaluation
                    SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
                    {
                        ...
                        _SampleTexture2D_16CF099B_RGBA_0.rgb = UnpackNormalmapRGorAG(_SampleTexture2D_16CF099B_RGBA_0);
            ...
            //-------------------------------------------------------------------------------------
                ...
                // Vertex Graph Evaluation
                    VertexDescription VertexDescriptionFunction(VertexDescriptionInputs IN)
                    {
                        ...
                        CalculateWind_float(IN.ObjectSpacePosition, IN.ObjectSpaceNormal, IN.TimeParameters.x, _CustomFunction_7B33222E_vertex_3, _CustomFunction_7B33222E_normal_4);
                        description.Position = _CustomFunction_7B33222E_vertex_3;
                        return description;
                    }
