        ...
        return t;
                ...
                // Pixel Graph Evaluation
                    SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
                    {
                        ...
                        float _Split_3F7F722E_R_1 = IN.WorldSpacePosition[0];
                        float _Split_3F7F722E_G_2 = IN.WorldSpacePosition[1];
                        float _Split_3F7F722E_B_3 = IN.WorldSpacePosition[2];
            ...
            //-------------------------------------------------------------------------------------
                ...
                // Vertex Graph Evaluation
                    VertexDescription VertexDescriptionFunction(VertexDescriptionInputs IN)
                    {
                        ...
                        description.Position = _CustomFunction_C73FB900_vertex_3;
                        return description;
                    }
