            ...
            //-------------------------------------------------------------------------------------
                ...
                // Pixel Graph Evaluation
                    SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
                    {
                        ...
                        _PlanarNM_555FFE40.WorldSpacePosition = IN.WorldSpacePosition;
                        _PlanarNM_555FFE40.uv0 = IN.uv0;
                        float4 _PlanarNM_555FFE40_XZ_2;
                        SG_PlanarNM_c0f081da9c567704ea36e7dd38cedcf6(TEXTURE2D_ARGS(_BaseColorMap, sampler_BaseColorMap), _Property_2353C4BE_Out_0, _Property_7041A8C7_Out_0, _PlanarNM_555FFE40, _PlanarNM_555FFE40_XZ_2);
                        ...
                        _PlanarNM_3662EA60.WorldSpacePosition = IN.WorldSpacePosition;
                        _PlanarNM_3662EA60.uv0 = IN.uv0;
                        float4 _PlanarNM_3662EA60_XZ_2;
                        SG_PlanarNM_c0f081da9c567704ea36e7dd38cedcf6(TEXTURE2D_ARGS(_CoverBaseColorMap, sampler_CoverBaseColorMap), _Property_2588572B_Out_0, _Property_1E3AA10A_Out_0, _PlanarNM_3662EA60, _PlanarNM_3662EA60_XZ_2);
                        ...
                        float _Property_8D694FD9_Out_0 = _UseDynamicCoverTStaticMaskF;
                        ...
                        _PlanarNMn_C2F28C9D.WorldSpacePosition = IN.WorldSpacePosition;
                        _PlanarNMn_C2F28C9D.uv0 = IN.uv0;
                        float4 _PlanarNMn_C2F28C9D_XZ_2;
                        SG_PlanarNMn_1b93a87456f9d4c419321d0cd92bd6c8(TEXTURE2D_ARGS(_BaseNormalMap, sampler_BaseNormalMap), _Property_2353C4BE_Out_0, _Property_7041A8C7_Out_0, _PlanarNMn_C2F28C9D, _PlanarNMn_C2F28C9D_XZ_2);
                        ...
                        _PlanarNMn_FD467CB3.WorldSpacePosition = IN.WorldSpacePosition;
                        _PlanarNMn_FD467CB3.uv0 = IN.uv0;
                        float4 _PlanarNMn_FD467CB3_XZ_2;
                        SG_PlanarNMn_1b93a87456f9d4c419321d0cd92bd6c8(TEXTURE2D_ARGS(_CoverNormalMap, sampler_CoverNormalMap), _Property_2588572B_Out_0, _Property_1E3AA10A_Out_0, _PlanarNMn_FD467CB3, _PlanarNMn_FD467CB3_XZ_2);
                        ...
                        float _Split_17815511_R_1 = IN.WorldSpacePosition[0];
                        float _Split_17815511_G_2 = IN.WorldSpacePosition[1];
                        float _Split_17815511_B_3 = IN.WorldSpacePosition[2];
                        ...
                        float3 _Transform_86338BFC_Out_1 = mul(transposeTangent, _Lerp_73D15502_Out_3.xyz).xyz;
                        ...
                        _PlanarNM_66DB1422.WorldSpacePosition = IN.WorldSpacePosition;
                        _PlanarNM_66DB1422.uv0 = IN.uv0;
                        float4 _PlanarNM_66DB1422_XZ_2;
                        SG_PlanarNM_c0f081da9c567704ea36e7dd38cedcf6(TEXTURE2D_ARGS(_CoverMaskMap, sampler_CoverMaskMap), _Property_2588572B_Out_0, _Property_1E3AA10A_Out_0, _PlanarNM_66DB1422, _PlanarNM_66DB1422_XZ_2);
                        ...
                        float _Branch_C2359BE7_Out_3;
                        Unity_Branch_float(_Property_8D694FD9_Out_0, _Multiply_82D5F0CF_Out_2, _Clamp_15F63226_Out_3, _Branch_C2359BE7_Out_3);
                        float3 _Lerp_E76EB7E0_Out_3;
                        Unity_Lerp_float3(_BlendOverlayBaseColor_886A4F00_OutVector4_1, (_Multiply_F4981DC6_Out_2.xyz), (_Branch_C2359BE7_Out_3.xxx), _Lerp_E76EB7E0_Out_3);
                        ...
                        Unity_Lerp_float3(_NormalBlend_D80EE7E9_Out_2, _NormalStrength_3173B408_Out_2, (_Branch_C2359BE7_Out_3.xxx), _Lerp_E6808EB9_Out_3);
                        Bindings_PlanarNM_c0f081da9c567704ea36e7dd38cedcf6 _PlanarNM_5F5E0B9;
                        _PlanarNM_5F5E0B9.WorldSpacePosition = IN.WorldSpacePosition;
                        _PlanarNM_5F5E0B9.uv0 = IN.uv0;
                        float4 _PlanarNM_5F5E0B9_XZ_2;
                        SG_PlanarNM_c0f081da9c567704ea36e7dd38cedcf6(TEXTURE2D_ARGS(_SpecularColorMap, sampler_SpecularColorMap), _Property_2353C4BE_Out_0, _Property_7041A8C7_Out_0, _PlanarNM_5F5E0B9, _PlanarNM_5F5E0B9_XZ_2);
                        ...
                        _PlanarNM_B988CEB4.WorldSpacePosition = IN.WorldSpacePosition;
                        _PlanarNM_B988CEB4.uv0 = IN.uv0;
                        float4 _PlanarNM_B988CEB4_XZ_2;
                        SG_PlanarNM_c0f081da9c567704ea36e7dd38cedcf6(TEXTURE2D_ARGS(_CoverSpecularColorMap, sampler_CoverSpecularColorMap), _Property_2588572B_Out_0, _Property_1E3AA10A_Out_0, _PlanarNM_B988CEB4, _PlanarNM_B988CEB4_XZ_2);
                        ...
                        Unity_Lerp_float4(_Multiply_FC26DFC_Out_2, _Multiply_17448DB5_Out_2, (_Branch_C2359BE7_Out_3.xxxx), _Lerp_879D3A81_Out_3);
                        Bindings_PlanarNM_c0f081da9c567704ea36e7dd38cedcf6 _PlanarNM_F325DF39;
                        _PlanarNM_F325DF39.WorldSpacePosition = IN.WorldSpacePosition;
                        _PlanarNM_F325DF39.uv0 = IN.uv0;
                        float4 _PlanarNM_F325DF39_XZ_2;
                        SG_PlanarNM_c0f081da9c567704ea36e7dd38cedcf6(TEXTURE2D_ARGS(_BaseMaskMap, sampler_BaseMaskMap), _Property_2353C4BE_Out_0, _Property_7041A8C7_Out_0, _PlanarNM_F325DF39, _PlanarNM_F325DF39_XZ_2);
                        ...
                        Unity_Lerp_float2(_Vector2_E35FE060_Out_0, _Vector2_1B22FDB0_Out_0, (_Branch_C2359BE7_Out_3.xx), _Lerp_8AC60F83_Out_3);
