Shader "NatureManufacture/HDRP/Layered/Top Cover"
{
    Properties
    {
            ...
            //-------------------------------------------------------------------------------------
                ...
                // Pixel Graph Evaluation
                    SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
                    {
                        ...
                        _PlanarNM_A76E9946.WorldSpacePosition = IN.WorldSpacePosition;
                        _PlanarNM_A76E9946.uv0 = IN.uv0;
                        float4 _PlanarNM_A76E9946_XZ_2;
                        SG_PlanarNM_c0f081da9c567704ea36e7dd38cedcf6(TEXTURE2D_ARGS(_BaseColorMap, sampler_BaseColorMap), _Property_3E4B16C8_Out_0, _Property_C80FF2EC_Out_0, _PlanarNM_A76E9946, _PlanarNM_A76E9946_XZ_2);
                        ...
                        _PlanarNM_4B363B4F.WorldSpacePosition = IN.WorldSpacePosition;
                        _PlanarNM_4B363B4F.uv0 = IN.uv0;
                        float4 _PlanarNM_4B363B4F_XZ_2;
                        SG_PlanarNM_c0f081da9c567704ea36e7dd38cedcf6(TEXTURE2D_ARGS(_BaseMaskMap, sampler_BaseMaskMap), _Property_3E4B16C8_Out_0, _Property_C80FF2EC_Out_0, _PlanarNM_4B363B4F, _PlanarNM_4B363B4F_XZ_2);
                        ...
                        _PlanarNM_3804E56F.WorldSpacePosition = IN.WorldSpacePosition;
                        _PlanarNM_3804E56F.uv0 = IN.uv0;
                        float4 _PlanarNM_3804E56F_XZ_2;
                        SG_PlanarNM_c0f081da9c567704ea36e7dd38cedcf6(TEXTURE2D_ARGS(_Base2ColorMap, sampler_Base2ColorMap), _Property_EDFDDF9F_Out_0, _Property_CE2CF8CB_Out_0, _PlanarNM_3804E56F, _PlanarNM_3804E56F_XZ_2);
                        ...
                        _PlanarNM_13A7B7CB.WorldSpacePosition = IN.WorldSpacePosition;
                        _PlanarNM_13A7B7CB.uv0 = IN.uv0;
                        float4 _PlanarNM_13A7B7CB_XZ_2;
                        SG_PlanarNM_c0f081da9c567704ea36e7dd38cedcf6(TEXTURE2D_ARGS(_Base2MaskMap, sampler_Base2MaskMap), _Property_EDFDDF9F_Out_0, _Property_CE2CF8CB_Out_0, _PlanarNM_13A7B7CB, _PlanarNM_13A7B7CB_XZ_2);
                        ...
                        float _Multiply_B74F0B8D_Out_2;
                        Unity_Multiply_float(_Split_9586C728_B_3, _Multiply_E91F2A9A_Out_2, _Multiply_B74F0B8D_Out_2);
                        ...
                        SG_HeightBlend_d15b6fb865d3b6d4ebc1fd476c3ad135((_Multiply_3B5A4F3A_Out_2.xyz), _Remap_26771F16_Out_3, (_Multiply_B97A88FA_Out_2.xyz), _Multiply_B74F0B8D_Out_2, _Property_B6701FF_Out_0, _HeightBlend_9D39BEA, _HeightBlend_9D39BEA_OutVector4_1);
                        ...
                        _PlanarNM_8FA871A2.WorldSpacePosition = IN.WorldSpacePosition;
                        _PlanarNM_8FA871A2.uv0 = IN.uv0;
                        float4 _PlanarNM_8FA871A2_XZ_2;
                        SG_PlanarNM_c0f081da9c567704ea36e7dd38cedcf6(TEXTURE2D_ARGS(_CoverBaseColorMap, sampler_CoverBaseColorMap), _Property_E0773BA3_Out_0, _Property_9A4313E5_Out_0, _PlanarNM_8FA871A2, _PlanarNM_8FA871A2_XZ_2);
                        ...
                        _PlanarNMn_DBE4B88E.WorldSpacePosition = IN.WorldSpacePosition;
                        _PlanarNMn_DBE4B88E.uv0 = IN.uv0;
                        float4 _PlanarNMn_DBE4B88E_XZ_2;
                        SG_PlanarNMn_1b93a87456f9d4c419321d0cd92bd6c8(TEXTURE2D_ARGS(_BaseNormalMap, sampler_BaseNormalMap), _Property_3E4B16C8_Out_0, _Property_C80FF2EC_Out_0, _PlanarNMn_DBE4B88E, _PlanarNMn_DBE4B88E_XZ_2);
                        ...
                        _PlanarNMn_6DB2DFFF.WorldSpacePosition = IN.WorldSpacePosition;
                        _PlanarNMn_6DB2DFFF.uv0 = IN.uv0;
                        float4 _PlanarNMn_6DB2DFFF_XZ_2;
                        SG_PlanarNMn_1b93a87456f9d4c419321d0cd92bd6c8(TEXTURE2D_ARGS(_Base2NormalMap, sampler_Base2NormalMap), _Property_EDFDDF9F_Out_0, _Property_CE2CF8CB_Out_0, _PlanarNMn_6DB2DFFF, _PlanarNMn_6DB2DFFF_XZ_2);
                        ...
                        SG_HeightBlend_d15b6fb865d3b6d4ebc1fd476c3ad135(_NormalStrength_EDF1EB8B_Out_2, _Remap_26771F16_Out_3, _NormalStrength_2C624796_Out_2, _Multiply_B74F0B8D_Out_2, _Property_B6701FF_Out_0, _HeightBlend_58735DF6, _HeightBlend_58735DF6_OutVector4_1);
                        ...
                        _PlanarNMn_72D32E68.WorldSpacePosition = IN.WorldSpacePosition;
                        _PlanarNMn_72D32E68.uv0 = IN.uv0;
                        float4 _PlanarNMn_72D32E68_XZ_2;
                        SG_PlanarNMn_1b93a87456f9d4c419321d0cd92bd6c8(TEXTURE2D_ARGS(_CoverNormalMap, sampler_CoverNormalMap), _Property_E0773BA3_Out_0, _Property_9A4313E5_Out_0, _PlanarNMn_72D32E68, _PlanarNMn_72D32E68_XZ_2);
                        ...
                        float _Absolute_EA960AB2_Out_1;
                        Unity_Absolute_float(_Divide_2E853816_Out_2, _Absolute_EA960AB2_Out_1);
                        float _Power_F952C21D_Out_2;
                        Unity_Power_float(_Absolute_EA960AB2_Out_1, _Subtract_5C7F53DB_Out_2, _Power_F952C21D_Out_2);
                        ...
                        float _Absolute_E16A8645_Out_1;
                        Unity_Absolute_float(_Multiply_F5867110_Out_2, _Absolute_E16A8645_Out_1);
                        float _Property_9B9027DB_Out_0 = _CoverHardness;
                        float _Power_B072AE57_Out_2;
                        Unity_Power_float(_Absolute_E16A8645_Out_1, _Property_9B9027DB_Out_0, _Power_B072AE57_Out_2);
                        ...
                        float3 _Transform_4F43343_Out_1 = mul(transposeTangent, _Lerp_A6AC44DC_Out_3.xyz).xyz;
                        ...
                        _PlanarNM_FC23FC30.WorldSpacePosition = IN.WorldSpacePosition;
                        _PlanarNM_FC23FC30.uv0 = IN.uv0;
                        float4 _PlanarNM_FC23FC30_XZ_2;
                        SG_PlanarNM_c0f081da9c567704ea36e7dd38cedcf6(TEXTURE2D_ARGS(_CoverMaskMap, sampler_CoverMaskMap), _Property_E0773BA3_Out_0, _Property_9A4313E5_Out_0, _PlanarNM_FC23FC30, _PlanarNM_FC23FC30_XZ_2);
                        ...
                        float _Multiply_C5BB284_Out_2;
                        Unity_Multiply_float(_Split_9586C728_G_2, _Multiply_5610F739_Out_2, _Multiply_C5BB284_Out_2);
                        float _Saturate_456E02AA_Out_1;
                        Unity_Saturate_float(_Multiply_C5BB284_Out_2, _Saturate_456E02AA_Out_1);
                        ...
                        SG_HeightBlend_d15b6fb865d3b6d4ebc1fd476c3ad135(_Vector3_FEF1FB88_Out_0, _Remap_26771F16_Out_3, _Vector3_9BA08694_Out_0, _Multiply_B74F0B8D_Out_2, _Property_B6701FF_Out_0, _HeightBlend_22E748BE, _HeightBlend_22E748BE_OutVector4_1);
